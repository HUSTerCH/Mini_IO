...
void btnHandler() {
    unsigned short btnCode = Xil_In8(XPAR_AXI_GPIO_2_BASEADDR+ XGPIO_DATA_OFFSET);
    switch (btnCode){
    case 0x01:
        num1 = Xil_In16(XPAR_AXI_GPIO_0_BASEADDR+XGPIO_DATA_OFFSET);
        xil_printf("led 1:%x\n",num1);
        Xil_Out16(XPAR_AXI_GPIO_0_BASEADDR+XGPIO_DATA2_OFFSET,num1);
        break;
    case 0x02:
        xil_printf("led add:%x\n",num1+num2);
        Xil_Out16(XPAR_AXI_GPIO_0_BASEADDR+XGPIO_DATA2_OFFSET,num1+num2);
        break;
    case 0x04:
        break;
    case 0x08:
        num2 = Xil_In16(XPAR_AXI_GPIO_0_BASEADDR+XGPIO_DATA_OFFSET);
        xil_printf("led 2:%x\n",num2);
        Xil_Out16(XPAR_AXI_GPIO_0_BASEADDR+XGPIO_DATA2_OFFSET,num2);
        break;
    case 0x10:
        xil_printf("led mutiply:%x\n",num1*num2);
        Xil_Out16(XPAR_AXI_GPIO_0_BASEADDR+XGPIO_DATA2_OFFSET,num1*num2);
        break;
    default:
        break;
